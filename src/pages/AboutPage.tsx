          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground">
                About <span className="gold-gradient-text italic">josephinecaribbean</span>
              </h1>
            </motion.div>
            ...
            >
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Born from a passion for authentic flame-grilled cuisine, josephinecaribbean brings the rich flavors 
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              {[
                ...
                { icon: Mail, text: "hello@josephinecaribbean.co.ke" },
                { icon: Instagram, text: "@josephinecaribbean" },
